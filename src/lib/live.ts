...
const policyNames: Record<PolicyName, string> = { trained: 'the trained readout', hardwired: 'nothing-trained mode', learning: 'live learning' };
...
function isPolicy(value: unknown): value is PolicyName {
  return value === 'trained' || value === 'hardwired' || value === 'learning';
}
