...
const PRESETS: { label: string; hint: string; types: string[] }[] = [
  { label: 'Steering · DNa02', hint: 'The 2 cells that turn the fly toward a target. Without them it still dodges threats but almost never finds food.', types: ['DNa02'] },
  { label: 'Escape · giant fiber', hint: 'The 2 escape neurons (DNp01). Without them the fly still goes for food but crashes about three times as often.', types: ['DNp01'] },
  { label: 'Food relays · AOTU', hint: 'The object detectors have no direct line to the steering neuron. The signal crosses 12 relay cells found by path search: AOTU025, AOTU012, AOTU015.', types: ['AOTU025', 'AOTU012', 'AOTU015'] },
];
